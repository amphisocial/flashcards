...
function attachBoardRoutes(app, deps) {
  ...
  const ANALYZE_INSTRUCTIONS = [
    ...
    '  "physicsSim": null OR { "type": one of "freefall","projectile","pendulum","incline","collision","orbit","welldeath","reflection","circuit", "g": number (9.8 Earth, 1.6 Moon), "air": true|false } - pick the type that matches the board,',
